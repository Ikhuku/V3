...
export default function RecentlyViewedPage() {
  ...
  const handleRemoveItem = (itemId) => {
    setRecentItems(recentItems.filter((item) => item.id !== itemId))
    console.log("Remove item from recent:", itemId)
  }
    ...
    <div className="min-h-screen bg-white md:hidden lg:hidden">
      ...
      <div className="px-6 pt-4">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl font-bold text-black">Recently viewed</h1>
