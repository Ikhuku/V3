    ...
    <div className="w-full h-screen font-[family-name:var(--font-josefin-sans)]">
      <div className="w-11/12 lg:w-10/12 h-screen mx-auto grid grid-cols-1 md:grid-cols-2 gap-7">
         <main className="h-full overflow-y-auto py-7 hideScroll">
            ...
            <form action="">
               <div className="mt-8">
                  <h1 className="mt-8 text-[#021236] text-3xl font-bold">Forgot Password?</h1>
                  <p className="text-[#787878] mt-1 font-bold text-md">Enter the email you used to register when you joined our platform and we’ll send you a code to reset your password</p>
               </div>
         ...
         <div className="w-full h-full hidden md:block overflow-hidden relative py-7">
          <Image src={item3} alt="" className="w-full h-full object-cover rounded-lg"/>
         </div>
      </div>
    </div>
  )
